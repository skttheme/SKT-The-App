...
<div class="space10"></div>
	...
	//Basic Settings
	$options[] = array(
		'name' => __('Basic Settings', 'skt-the-app'),
		'type' => 'heading');

	$options[] = array(
		'name' => __('Logo', 'skt-the-app'),
		'desc' => __('Upload your main logo here', 'skt-the-app'),
		'id' => 'logo',
		'class' => '',
		'std'	=> '',
		'type' => 'upload');
	...
	$options[] = array(
		'name' => __('Favicon', 'skt-the-app'),
		'desc' => __('Upload favicon for website', 'skt-the-app'),
		'id' => 'favicon',
		'class' => '',
		'std'	=> '',
		'type' => 'upload');
	...
	//Layout Settings
	$options[] = array(
		'name' => __('Sections', 'skt-the-app'),
		'type' => 'heading');

	$options[] = array(
		'name' => __('Number of Sections', 'skt-the-app'),
		'desc' => __('Select number of sections', 'skt-the-app'),
		'id' => 'numsection',
		'type' => 'select',
		'std' => '7',
	...
	for( $n=1; $n<=$numsecs; $n++){
		$options[] = array(
			'desc' => __("<h3>Section</h3>", 'skt-the-app'),
			'class' => 'toggle_title',
			'type' => 'info');	
	
		$options[] = array(
			'name' => __('Section Title', 'skt-the-app'),
			'id' => 'sectiontitle'.$n,
			'std' => ( ( isset($section_text[$n]['section_title']) ) ? $section_text[$n]['section_title'] : '' ),
			'type' => 'text');

		$options[] = array(
			'name' => __('Section Background Color', 'skt-the-app'),
			'desc' => __('Select background color for section', 'skt-the-app'),
			'id' => 'sectionbgcolor'.$n,
			'std' => ( ( isset($section_text[$n]['bgcolor']) ) ? $section_text[$n]['bgcolor'] : '' ),
			'type' => 'color');

		$options[] = array(
			'name' => __('Section CSS Class', 'skt-the-app'),
			'desc' => __('Set class for this section.', 'skt-the-app'),
			'id' => 'sectionclass'.$n,
			'std' => ( ( isset($section_text[$n]['class']) ) ? $section_text[$n]['class'] : '' ),
			'type' => 'text');

		$options[] = array(
			'name' => __('Section Content', 'skt-the-app'),
			'id' => 'sectioncontent'.$n,
	...
	//SLIDER SETTINGS
	$options[] = array(
		'name' => __('Slider Images', 'skt-the-app'),
		'type' => 'heading');

	$options[] = array(
		'name' => __('Slider Image 1', 'skt-the-app'),
		'desc' => __('Upload / select image for slide 1', 'skt-the-app'),
		'id' => 'slide1',
		'class' => '',
	...
	$options[] = array(
		'desc' => __('Title 1', 'skt-the-app'),
		'id' => 'slidetitle1',
		'std' => 'Free Business WordPress Theme',
		'type' => 'text');

	$options[] = array(
		'desc' => __('Slide Description 1', 'skt-the-app'),
		'id' => 'slidedesc1',
	...
	$options[] = array(
		'desc' => __('Link / Url 1', 'skt-the-app'),
		'id' => 'slideurl1',
		'std' => '#link1',
		'type' => 'text',
		'subtype' => 'url');
	...
	$options[] = array(
		'name' => __('Slider Image 2', 'skt-the-app'),
		'desc' => __('Upload / select image for slide 2', 'skt-the-app'),
		'id' => 'slide2',
		'class' => '',
	...
	$options[] = array(
		'desc' => __('Title 2', 'skt-the-app'),
		'id' => 'slidetitle2',
		'std' => 'Fully Responsive WordPress Theme',
		'type' => 'text');

	$options[] = array(
		'desc' => __('Slide Description 2', 'skt-the-app'),
		'id' => 'slidedesc2',
	...
	$options[] = array(
		'desc' => __('Link / Url 2', 'skt-the-app'),
		'id' => 'slideurl2',
		'std' => '#link2',
		'type' => 'text',
		'subtype' => 'url');
	...
	$options[] = array(
		'name' => __('Slider Image 3', 'skt-the-app'),
		'desc' => __('Upload / select image for slide 3', 'skt-the-app'),
		'id' => 'slide3',
		'class' => '',
		'std' => get_template_directory_uri()."/images/slides/1slide1.png",
		'type' => 'upload');
	...
	$options[] = array(
		'desc' => __('Title 3', 'skt-the-app'),
		'id' => 'slidetitle3',
		'std' => 'Easy to Use',
		'type' => 'text');

	$options[] = array(
		'desc' => __('Slide Description 3', 'skt-the-app'),
		'id' => 'slidedesc3',
	...
	$options[] = array(
		'desc' => __('Link / Url 3', 'skt-the-app'),
		'id' => 'slideurl3',
		'std' => '#link3',
		'type' => 'text',
		'subtype' => 'url');
	...
	$options[] = array(
		'name' => __('Slider Image 4', 'skt-the-app'),
		'desc' => __('Upload / select image for slide 4', 'skt-the-app'),
		'id' => 'slide4',
		'class' => '',
		'std' => '',
		'type' => 'upload');
	...
	$options[] = array(
		'desc' => __('Title 4', 'skt-the-app'),
		'id' => 'slidetitle4',
		'std' => '',
		'type' => 'text');

	$options[] = array(
		'desc' => __('Slide Description 4', 'skt-the-app'),
		'id' => 'slidedesc4',
		'std' => '',
		'type' => 'textarea');			
		
	$options[] = array(
		'desc' => __('Link / Url 4', 'skt-the-app'),
		'id' => 'slideurl4',
		'std' => '',
		'type' => 'text',
		'subtype' => 'url');
	...
	$options[] = array(
		'name' => __('Slider Image 5', 'skt-the-app'),
		'desc' => __('Upload / select image for slide 5', 'skt-the-app'),
		'id' => 'slide5',
		'class' => '',
		'std' => '',
		'type' => 'upload');
	...
	$options[] = array(
		'desc' => __('Title 5', 'skt-the-app'),
		'id' => 'slidetitle5',
		'std' => '',
		'type' => 'text');

	$options[] = array(
		'desc' => __('Slide Description 5', 'skt-the-app'),
		'id' => 'slidedesc5',
		'std' => '',
		'type' => 'textarea');			
		
	$options[] = array(
		'desc' => __('Link / Url 5', 'skt-the-app'),
		'id' => 'slideurl5',
		'std' => '',
		'type' => 'text',
		'subtype' => 'url');
	...
	//Social
	$options[] = array(
		'name' => __('Social Settings', 'skt-the-app'),
		'type' => 'heading');
	
	$options[] = array(
		'name' => __('Social Links', ''),
		'desc' => __('Add your facebook link here with http://', 'skt-the-app'),
		'id'   => 'fbicon',
		'std'  => '#',
		'type' => 'text');
		
	$options[] = array(
		'desc' => __('Add your google plus link here with http://', 'skt-the-app'),
		'id'   => 'gplusicon',
		'std'  => '#',
		'type' => 'text');
		
	$options[] = array(
		'desc' => __('Add your Twitter link here with http://', 'skt-the-app'),
		'id'   => 'twitticon',
		'std'  => '#',
		'type' => 'text');
		
	$options[] = array(
		'desc' => __('Add your Linkedin link here with http://', 'skt-the-app'),
		'id'   => 'linkedicon',
		'std'  => '#',
		'type' => 'text');
	...
	// Support					
	$options[] = array(
		'name' => __('Our Themes', 'skt-the-app'),
		'type' => 'heading');

	$options[] = array(
		'desc' => __('SKT The App WordPress theme has been Designed and Created by SKT Themes.', 'skt-the-app'),
		'type' => 'info');	

	 $options[] = array(
		'desc' => '<a href="'.esc_url(SKT_URL).'" target="_blank"><img src="'.get_template_directory_uri().'/images/sktskill.jpg"></a><p><em><a target="_blank" href="'.esc_url(SKT_THEME_URL_DIRECT).'">'.__('Buy PRO version for only $39 with more features.','skt-the-app').'</a></em></p>',
		'type' => 'info');	
