...
function the_app_setup() {
	...
	load_theme_textdomain( 'skt-the-app', get_template_directory() . '/languages' );
...
function the_app_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Blog Sidebar', 'skt-the-app' ),
		'description'   => __( 'Appears on blog page sidebar', 'skt-the-app' ),
		'id'            => 'sidebar-1',
...
function the_app_fonts_url() {
    ...
    */
    $open_sans = _x( 'on', 'Open Sans font: on or off', 'skt-the-app' );
...
define('SKT_THEME_URL_DIRECT','http://www.sktthemes.org/themes/theapp_pro/');
define('SKT_URL','http://www.sktthemes.org');
define('SKT_THEME_URL','http://www.sktthemes.org/themes');
define('SKT_THEME_DOC','http://sktthemesdemo.org/documentation/theapp-documentation/');