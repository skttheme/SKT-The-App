...
function of_recognized_background_repeat() {
	...
	$default = array(
		'no-repeat' => __( 'No Repeat', 'skt-the-app' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'skt-the-app' ),
		'repeat-y'  => __( 'Repeat Vertically', 'skt-the-app' ),
		'repeat'    => __( 'Repeat All', 'skt-the-app' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'skt-the-app' ),
		'top center'    => __( 'Top Center', 'skt-the-app' ),
		'top right'     => __( 'Top Right', 'skt-the-app' ),
		'center left'   => __( 'Middle Left', 'skt-the-app' ),
		'center center' => __( 'Middle Center', 'skt-the-app' ),
		'center right'  => __( 'Middle Right', 'skt-the-app' ),
		'bottom left'   => __( 'Bottom Left', 'skt-the-app' ),
		'bottom center' => __( 'Bottom Center', 'skt-the-app' ),
		'bottom right'  => __( 'Bottom Right', 'skt-the-app')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'skt-the-app' ),
		'fixed'  => __( 'Fixed in Place', 'skt-the-app')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'skt-the-app' ),
		'italic'      => __( 'Italic', 'skt-the-app' ),
		'bold'        => __( 'Bold', 'skt-the-app' ),
		'bold italic' => __( 'Bold Italic', 'skt-the-app' )
		);
